...
FSSMF Atlas charts are available in [CXL format](https://cmap.ihmc.us/xml/cxl.html). We suggest downloading and exploring FSSMF Atlas charts with [CmapTools](https://cmap.ihmc.us/) (Version 6.03), the software used to create them. FSSMF Atlas charts should be imported. Additional and novel environments for navigation, visualization, and retrieval of FSSMF charts will come soon.
